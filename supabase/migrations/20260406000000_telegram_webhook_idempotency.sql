-- Dedupe Telegram webhook deliveries (retries and replay protection).
-- Written by telegram-webhook edge function only after secret-token and chat allowlist pass.
